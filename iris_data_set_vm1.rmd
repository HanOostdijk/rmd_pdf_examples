...
The main disadvantage is that internal references to figure and tables are not available. In the next example we will show how to do this for the pdf case but this introduces a differences between the three document formats.
