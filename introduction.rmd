...
\mytextit{NB. handling of bibliographies in the manner done here is suddenly changed in package rmarkdown version 1.9 . I~have regressed to version 1.8.1 (by using the r package \mytextbf{rmis}) but will try to find out how to fix this in the newer version.}
