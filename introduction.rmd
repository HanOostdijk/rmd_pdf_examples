...
This document describes some examples of the use of RMarkdown to produce PDF files. The examples differ in the measure that additional \LaTeX \  functionality has been used. 
