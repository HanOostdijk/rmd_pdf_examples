...
The only drawback of this way of working is that the captions for the tables are always placed above (before) the table.
...
\bibitem[RStudio]{RStudio} RStudio Version 1.1.238  \copyright \ 2009-2016 RStudio, Inc. 
